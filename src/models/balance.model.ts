...
let BalanceSchema: Schema = new Schema({
    owner: {
        type: ObjectId,
        required: true,
        ref: 'User'
...
let BalanceModel: Model<IBalanceModel> = model<IBalanceModel>("Balance", BalanceSchema)

export class Balance extends BalanceModel {
}